...
const kuddus = {
  id: 101,
  name: "Kuddus Boyati",
  education: { ssc: 3.0, hsc: 3.5, degree: "BSS" },
...
const devider = (devide) => devide / 7;
// const result = devider(50)
// console.log(result);
...
const twoPara = (num1, num2) => (num1 + num2) / 2;
// const output = twoPara(10, 20)
// console.log(output);
...
//ম্যাপ হলো  প্রত্যেক টা এরেকে লুপ করে এবং একটা রেজাল্ট রিটার্ন করে।
//ফরইচ প্রত্যেক টা এরে কে লুপ করে কিন্তু কোনো কিছু রিটার্ন করেনা।
//ফিল্টার প্রত্যেক টা কে লুপ করবে কিন্তু যেগুলো সত্যি সেগলো কে রিটার্ন করবে।
...
const student = {
  ...
  languages: {
    native: "bangla",
    welUnderstand: "english",
    speak: "hindi",
  },
};

const { languages } = student;
// console.log(languages);
const { native } = student.languages;
// console.log(native);

const numDist = [12, 54, 65, 43, 22, 11, 8];
const [num1, balance] = numDist;
console.log(balance);
